...
good_solution_path = resolver.Rlocation(
    'rules_contest/tests/interactive_judge/good_solution')
half_solution_path = resolver.Rlocation(
    'rules_contest/tests/interactive_judge/half_solution')
bad_solution_path = resolver.Rlocation(
    'rules_contest/tests/interactive_judge/bad_solution')
